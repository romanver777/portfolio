...
/***/ function(module, exports, __webpack_require__) {
	...
	var textures = [{
	  file: './assets/img/content/bg_forest_1800.jpg',
	  name: 'image',
	  align: textureAlign,
	  scale: { x: 1, y: 1 }
	}, {
	  file: './assets/img/content/water-maps.jpg',
	  name: 'maps',
	  align: textureAlign,
	  scale: { x: 0.1, y: 0.2 }
	}];
	...
	function updateSize() {
	  var container = document.querySelector('.canvas__bg');
...
/***/ function(module, exports) {
	...
	function createProgram(gl, vertexScript, fragScript) {
	  ...
	  gl.vertexAttribPointer(texCoordLocation, 1, gl.FLOAT, false, 0, 0);
